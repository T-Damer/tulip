...
export default function PhotoSwipe({ items }: { items: Media[] }) {
  return (
    <div
      className="mt-32 flex min-h-44 snap-x flex-row overflow-x-scroll border-b-2 sm:mt-0 xl:h-full xl:w-3/4 xl:snap-y xl:flex-col xl:overflow-y-scroll xl:border-b-0 xl:border-l-2"
      onWheel={(ev) => {
